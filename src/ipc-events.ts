export const enum IpcEvents {
  ...
  CACHETOOL_DOWNLOAD = 'CACHETOOL_DOWNLOAD',
  CACHETOOL_GET_HEADERS = 'CACHETOOL_GET_HEADERS',
  CACHETOOL_GET_DATA = 'CACHETOOL_GET_DATA',
  CACHETOOL_LIST_KEYS = 'CACHETOOL_LIST_KEYS',
